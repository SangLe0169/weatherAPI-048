...
import com.example.ungdungthoitiet.adapter.TabPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.ungdungthoitiet.adapter.TabPagerAdapter tabPagerAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.menu_about:
                ...
                View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.about_daialog, null);
