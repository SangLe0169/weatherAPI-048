package com.example.ungdungthoitiet.adapter;
...
import com.example.ungdungthoitiet.extras.Constant;
import com.example.ungdungthoitiet.extras.TimeAndDateConverter;
...
public class SearchForecastRVAdapter extends RecyclerView.Adapter<SearchForecastRVAdapter.ForecastViewHolder>{
    ...
    List<com.example.ungdungthoitiet.model.ForecastWeather.List> weatherList;
    private Context context;
    private String tempUnit;

    public SearchForecastRVAdapter(List<com.example.ungdungthoitiet.model.ForecastWeather.List> weatherList, Context context, String tempUnit) {
    ...
    public ForecastViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_forcast_single_row, parent, false);
    ...
    public void updateCollection(List<com.example.ungdungthoitiet.model.ForecastWeather.List> weatherList){
        this.weatherList = weatherList;
